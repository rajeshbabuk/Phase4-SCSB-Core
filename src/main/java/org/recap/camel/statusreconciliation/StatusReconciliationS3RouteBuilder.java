                ...
                camelContext.addRoutes(new RouteBuilder() {
                    ...
                    public void configure() throws Exception {
                        from(ScsbConstants.STATUS_RECONCILIATION_REPORT)
                                ...
                                .onCompletion()
                                    .onWhen(header(ScsbConstants.FOR).isEqualTo(ScsbConstants.STATUS_RECONCILIATION))
                                    ...
                                    .onWhen(header(ScsbConstants.FOR).isEqualTo(ScsbConstants.STATUS_RECONCILIATION_FAILURE))
                                        .log("status reconciliation process finished files generated in S3 for Failure report")
